...
public class FBSuspensionAnimator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        frSpring.localScale = new Vector3(0.5f,0.8f + 0.7f * angle,0.5f); // Anime le ressort
        ...
        flSpring.localScale = new Vector3(0.5f,0.8f + 0.7f * angle,0.5f); // Anime le ressort
        ...
        rrSpring.localScale = new Vector3(0.5f,0.8f + 0.7f * angle,0.5f); // Anime le ressort
        ...
        rlSpring.localScale = new Vector3(0.5f,0.8f + 0.7f * angle,0.5f); // Anime le ressort
